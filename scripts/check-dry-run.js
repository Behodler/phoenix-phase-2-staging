 ...
 * check-dry-run.js
 *
 * This script validates the progress.1.json file from a dry run to ensure
 ...
 *   1 - Error: No progress file found (must run deploy:mainnet-preview first)
...
function checkDryRun() {
    console.log('==========================================');
    console.log('  Validating Mainnet Dry Run Results');
    console.log('==========================================');
    console.log('');

    // Check if progress file exists
    if (!fs.existsSync(PROGRESS_FILE)) {
        console.error('ERROR: progress.1.json not found!');
        console.error('');
        console.error('You must run a dry run first:');
        console.error('  npm run deploy:mainnet-preview');
        console.error('');
        console.error('The dry run will generate progress.1.json which is used to:');
    ...
    try {
        ...
        console.error('ERROR: Could not parse progress.1.json');
    ...
    console.log('==========================================');
    console.log('');
    console.log('All deployment steps completed successfully in dry run.');
    console.log('');
    ...
    console.log('  1. Delete progress.1.json');
    console.log('  2. Run the deployment script with --broadcast');
    console.log('  3. Generate a new progress.1.json as it deploys');
    console.log('');
