...
export const antimatterAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'stable', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    inputs: [],
    name: 'phUSD',
    outputs: [{ name: '', internalType: 'contract IFlax', type: 'address' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    ...
    name: 'phUSDMinter',
    outputs: [
      { name: '', internalType: 'contract PhusdStableMinter', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  {
    type: 'function',
    inputs: [{ name: 'newPauser', internalType: 'address', type: 'address' }],
    name: 'setPauser',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    inputs: [
      { name: 'newPhUSD', internalType: 'contract IFlax', type: 'address' },
    ],
    name: 'setPhUSD',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      {
        name: 'newMinter',
        internalType: 'contract PhusdStableMinter',
        type: 'address',
      },
    ],
    name: 'setPhUSDMinter',
  ...
  { type: 'error', inputs: [], name: 'ApprovedMinterZeroAddress' },
  {
    type: 'error',
    inputs: [
      { name: 'stable', internalType: 'address', type: 'address' },
      { name: 'registered', internalType: 'uint8', type: 'uint8' },
  ...
  {
    type: 'error',
    inputs: [{ name: 'stable', internalType: 'address', type: 'address' }],
  ...
  { type: 'error', inputs: [], name: 'ExpectedPause' },
  {
    ...
    name: 'InsufficientPhUSDOut',
  },
  {
    type: 'error',
    inputs: [{ name: 'caller', internalType: 'address', type: 'address' }],
    name: 'NotApprovedMinter',
  },
  { type: 'error', inputs: [], name: 'OnlyOwnerOrPauser' },
  ...
  },
  {
    type: 'error',
    inputs: [
      { name: 'minterPhUSD', internalType: 'address', type: 'address' },
      { name: 'expectedPhUSD', internalType: 'address', type: 'address' },
    ],
    name: 'PhUSDMinterMismatch',
  },
  { type: 'error', inputs: [], name: 'PhUSDMinterNotSet' },
  { type: 'error', inputs: [], name: 'PhUSDMinterZeroAddress' },
  { type: 'error', inputs: [], name: 'PhUSDNotSet' },
  { type: 'error', inputs: [], name: 'PhUSDZeroAddress' },
  { type: 'error', inputs: [], name: 'RecipientZeroAddress' },
  ...
  { type: 'error', inputs: [], name: 'StableNotDeposited' },
  {
    type: 'error',
    inputs: [{ name: 'stable', internalType: 'address', type: 'address' }],
...
export const balancerPoolerMintDebtHookAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'initialOwner', internalType: 'address', type: 'address' },
      { name: 'dispatcher_', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    name: 'phUSD',
    outputs: [
      { name: '', internalType: 'contract IMintable', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  { type: 'error', inputs: [], name: 'OnlyDispatcher' },
  { type: 'error', inputs: [], name: 'OnlyOwnerOrRecipient' },
  {
    type: 'error',
    inputs: [{ name: 'owner', internalType: 'address', type: 'address' }],
    name: 'OwnableInvalidOwner',
  ...
  { type: 'error', inputs: [], name: 'RatioTooHigh' },
  { type: 'error', inputs: [], name: 'RecipientUnset' },
  { type: 'error', inputs: [], name: 'ReentrancyGuardReentrantCall' },
] as const
...
export const balancerPoolerV2Abi = [
  {
    type: 'constructor',
    inputs: [
      ...
      { name: 'sUSDSIsFirst_', internalType: 'bool', type: 'bool' },
      { name: 'initialOwner', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
...
export const batchNftMinterAbi = [
  ...
  {
    type: 'function',
    inputs: [{ name: 'newIndex', internalType: 'uint256', type: 'uint256' }],
    name: 'setDispatcherIndex',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  { type: 'error', inputs: [], name: 'BatchMint__DispatcherNotConfigured' },
  { type: 'error', inputs: [], name: 'BatchMint__MinterNotConfigured' },
  {
    type: 'error',
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      { name: 'minReward', internalType: 'uint256', type: 'uint256' },
      { name: 'actualReward', internalType: 'uint256', type: 'uint256' },
    ],
  ...
  { type: 'error', inputs: [], name: 'Rescue__ZeroRecipient' },
  {
    type: 'error',
    inputs: [{ name: 'token', internalType: 'address', type: 'address' }],
    name: 'SafeERC20FailedOperation',
...
export const batchNftMinterMultiTokenAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'initialOwner', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'recipient', internalType: 'address', type: 'address' },
      { name: 'paymentAmount', internalType: 'uint256', type: 'uint256' },
      { name: 'minRewards', internalType: 'uint256[]', type: 'uint256[]' },
    ],
    name: 'batchMint',
    outputs: [{ name: 'totalPaid', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'NudgeTokenWhitelistChanged',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    type: 'error',
    inputs: [
      { name: 'tokensLength', internalType: 'uint256', type: 'uint256' },
      { name: 'minsLength', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'BatchMint__ArrayLengthMismatch',
  },
  { type: 'error', inputs: [], name: 'BatchMint__DispatcherNotConfigured' },
  { type: 'error', inputs: [], name: 'BatchMint__MinterNotConfigured' },
  {
    type: 'error',
    inputs: [{ name: 'token', internalType: 'address', type: 'address' }],
    name: 'BatchMint__NudgeTokenAlreadyWhitelisted',
  },
  {
    type: 'error',
    inputs: [{ name: 'token', internalType: 'address', type: 'address' }],
    name: 'BatchMint__NudgeTokenNotWhitelisted',
  },
  {
    type: 'error',
    inputs: [
    ...
    name: 'BatchMint__PaymentBudgetExhausted',
  },
  {
    type: 'error',
    inputs: [
...
export const depositPageViewAbi = [
  {
    type: 'constructor',
    inputs: [
...
export const depositPageViewV3Abi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_phlimbo',
        internalType: 'contract IPhlimboV3',
        type: 'address',
      },
      { name: '_phUSD', internalType: 'contract IERC20', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'phlimbo',
    outputs: [
      { name: '', internalType: 'contract IPhlimboV3', type: 'address' },
    ],
    stateMutability: 'view',
  },
] as const
...
export const erc4626MarketYieldStrategyAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_owner', internalType: 'address', type: 'address' },
      { name: '_underlyingToken', internalType: 'address', type: 'address' },
      { name: '_erc4626Vault', internalType: 'address', type: 'address' },
      { name: '_ammAdapter', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'ammAdapter',
    outputs: [
      { name: '', internalType: 'contract IAMMAdapter', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'deposit',
    outputs: [
      { name: 'creditedPrincipal', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'relinquishPrincipalAsOwner',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'client', internalType: 'address', type: 'address' },
      { name: 'bufferPercent', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'setSetAsideBuffer',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'setSetAsideBufferRecipient',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'withdrawalStates',
    outputs: [
      { name: 'initiatedAt', internalType: 'uint256', type: 'uint256' },
      {
        name: 'status',
        internalType: 'enum AYieldStrategy.WithdrawalStatus',
        type: 'uint8',
      },
      { name: 'balance', internalType: 'uint256', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    name: 'SetAsideBufferRecipientSet',
  },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    name: 'WithdrawerAuthorizationSet',
  },
  {
    type: 'event',
    anonymous: false,
...
export const erc4626YieldStrategyAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_owner', internalType: 'address', type: 'address' },
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'mintVersion', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
...
export const iPhlimboAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: '_accPhUSDPerShare', internalType: 'uint256', type: 'uint256' },
      { name: '_accStablePerShare', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      { name: 'amount', internalType: 'uint256', type: 'uint256' },
      { name: 'phUSDDebt', internalType: 'uint256', type: 'uint256' },
      { name: 'stableDebt', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
...
export const migratorV2V3Abi = [
  {
    type: 'constructor',
    inputs: [
      { name: '_phlimboV2', internalType: 'address', type: 'address' },
      { name: '_phlimboV3', internalType: 'address', type: 'address' },
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'maxIterations', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'migrate',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'phlimboV2',
    outputs: [
      { name: '', internalType: 'contract IPhlimboV2', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const mintPageViewAbi = [
  {
    ...
    inputs: [
      {
        name: '_nftMinter',
        internalType: 'contract INFTMinterV2',
        type: 'address',
      },
      {
        name: '_burnRecorder',
  ...
  },
  {
    ...
    name: 'nftMinter',
    outputs: [
      { name: '', internalType: 'contract INFTMinterV2', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const mockPhUsdAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct MockPhUSD.MinterInfo',
        type: 'tuple',
        components: [
          { name: 'canMint', internalType: 'bool', type: 'bool' },
          { name: 'mintVersion', internalType: 'uint256', type: 'uint256' },
...
export const mockRewardTokenAbi = [
  { type: 'constructor', inputs: [], stateMutability: 'nonpayable' },
  {
    type: 'function',
    inputs: [
...
export const multiPoolerAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'calls',
        internalType: 'struct MultiPooler.PoolCall[]',
        type: 'tuple[]',
        components: [
          { name: 'uniboost', internalType: 'address', type: 'address' },
          { name: 'amountIn', internalType: 'uint256', type: 'uint256' },
          { name: 'minPairOut', internalType: 'uint256', type: 'uint256' },
          { name: 'minTargetOut', internalType: 'uint256', type: 'uint256' },
  ...
  {
    type: 'function',
    inputs: [{ name: 'newPooler', internalType: 'address', type: 'address' }],
    name: 'setPooler',
    outputs: [],
    stateMutability: 'nonpayable',
  },
...
export const nftMinterV2Abi = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'index', internalType: 'uint256', type: 'uint256' },
      {
        name: 'newGrowthBasisPoints',
        internalType: 'uint256',
        type: 'uint256',
      },
    ],
    name: 'setGrowthFactor',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
...
export const nftStakerAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_stakedId', internalType: 'uint256', type: 'uint256' },
      {
        name: '_rewardToken',
      ...
      {
        name: '_nftMinter',
        internalType: 'contract INFTSupply',
        type: 'address',
      },
      { name: '_dispatcherIndex', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'contract IBalancerPoolerMintDebtHook',
        type: 'address',
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    name: 'nftMinter',
    outputs: [
      { name: '', internalType: 'contract INFTSupply', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  {
    type: 'function',
    inputs: [{ name: 'newId', internalType: 'uint256', type: 'uint256' }],
    name: 'setStakedId',
    outputs: [],
    stateMutability: 'nonpayable',
  },
...
export const nftStakerDepletionAbi = [
  {
    type: 'constructor',
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'contract IUniboostMintDebtHook',
        type: 'address',
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'enum NFTStakerDepletion.PoolState',
        type: 'uint8',
      },
    ],
    stateMutability: 'view',
  ...
  {
    type: 'function',
    inputs: [{ name: 'months', internalType: 'uint256', type: 'uint256' }],
    name: 'setDepletionWindow',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  { type: 'event', anonymous: false, inputs: [], name: 'PoolReset' },
  {
    type: 'event',
    anonymous: false,
    inputs: [
...
export const nftStakerDepletionV2Abi = [
  {
    type: 'constructor',
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'enum NFTStakerDepletionV2.PoolState',
        type: 'uint8',
      },
    ],
    stateMutability: 'view',
...
export const nftStakerMigratorAbi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_oldStaker',
        internalType: 'contract INFTStakerMigratable',
        type: 'address',
      },
      {
        name: '_newStaker',
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NFTStakerPriceScaled
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

export const nftStakerPriceScaledAbi = [
  {
    type: 'constructor',
    inputs: [
      {
      ...
      { name: '_dispatcherIndex', internalType: 'uint256', type: 'uint256' },
      { name: '_priceScale', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
  },
  {
...
export const nudgeRatchetAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'token_', internalType: 'address', type: 'address' },
      { name: 'batchMinter_', internalType: 'address', type: 'address' },
      { name: 'initialOwner', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
...
export const nudgeStreamerAbi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'batchMinter', internalType: 'address', type: 'address' },
      { name: 'token', internalType: 'address', type: 'address' },
    ],
    name: 'pendingStream',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'rewardPerSecond', internalType: 'uint256', type: 'uint256' },
  ...
  { type: 'error', inputs: [], name: 'NudgeStreamer__NotRegistered' },
  {
    type: 'error',
    inputs: [
      { name: 'batchMinter', internalType: 'address', type: 'address' },
    ...
    name: 'NudgeStreamer__NotWhitelisted',
  },
...
export const pauserAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'eyeTokenAddress', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'pausableContract', internalType: 'address', type: 'address' },
    ],
    name: 'register',
    outputs: [],
    stateMutability: 'nonpayable',
...
export const phlimboV2Abi = [
  ...
  },
  {
    type: 'function',
    inputs: [],
    name: 'getPendingAPYInfo',
    outputs: [
      { name: '_pendingAPYBps', internalType: 'uint256', type: 'uint256' },
      {
        name: '_pendingAPYBlockNumber',
        internalType: 'uint256',
        type: 'uint256',
      },
      { name: '_apySetInProgress', internalType: 'bool', type: 'bool' },
    ],
    stateMutability: 'view',
  },
  {
...
export const phlimboV3Abi = [
  ...
  },
  {
    type: 'function',
    inputs: [
      { name: 'leftoverRecipient', internalType: 'address', type: 'address' },
    ],
    name: 'finalizePromotion',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'getPromoInfo',
    outputs: [
      { name: '_promoToken', internalType: 'address', type: 'address' },
      { name: '_promoRewardBalance', internalType: 'uint256', type: 'uint256' },
      {
        name: '_promoRewardPerSecond',
        internalType: 'uint256',
        type: 'uint256',
      },
      {
        name: '_promoDepletionDuration',
        internalType: 'uint256',
        type: 'uint256',
      },
      {
        name: '_promoPhase',
        internalType: 'enum IPhlimboV3.PromoPhase',
        type: 'uint8',
      },
      { name: '_flushCursor', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'promoPhase',
    outputs: [
      { name: '', internalType: 'enum IPhlimboV3.PromoPhase', type: 'uint8' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'setPromoDepletionDuration',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'phUSDDebt', internalType: 'uint256', type: 'uint256' },
      { name: 'stableDebt', internalType: 'uint256', type: 'uint256' },
      { name: 'promoDebt', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'PromoDepletionDurationUpdated',
  },
  {
    type: 'event',
    anonymous: false,
...
export const phusdStableMinterAbi = [
  {
    type: 'constructor',
    inputs: [{ name: '_phUSD', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    inputs: [
      { name: 'token', internalType: 'address', type: 'address' },
      { name: 'yieldStrategy', internalType: 'address', type: 'address' },
    ],
    name: 'approveYS',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    type: 'function',
    inputs: [{ name: 'stablecoin', internalType: 'address', type: 'address' }],
    name: 'getStablecoinConfig',
    outputs: [
      {
        name: '',
        internalType: 'struct PhusdStableMinter.StablecoinConfig',
        type: 'tuple',
        components: [
          { name: 'yieldStrategy', internalType: 'address', type: 'address' },
          ...
          { name: 'maxMintPerDay', internalType: 'uint256', type: 'uint256' },
          { name: 'mintedToday', internalType: 'uint256', type: 'uint256' },
          {
  ...
  },
  {
    ...
    inputs: [
      { name: 'stablecoin', internalType: 'address', type: 'address' },
      { name: 'newMaxMintPerDay', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'setMaxMintPerDay',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'maxMintPerDay', internalType: 'uint256', type: 'uint256' },
      { name: 'mintedToday', internalType: 'uint256', type: 'uint256' },
      { name: 'lastMintTimestamp', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: 'newMaxMintPerDay',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
    ],
    name: 'MaxMintPerDayUpdated',
  },
  {
    type: 'event',
    anonymous: false,
...
export const stableStakerV2Abi = [
  {
    type: 'constructor',
    inputs: [
      {
        name: '_antimatter',
        internalType: 'contract IAntimatter',
        type: 'address',
      },
      { name: 'initialOwner', internalType: 'address', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'antimatter',
    outputs: [
      { name: '', internalType: 'contract IAntimatter', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [
      { name: 'token', internalType: 'address', type: 'address' },
      { name: 'amountPerDay', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'antimatterPerDay',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'principalSnapshot', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'poolInfo',
    outputs: [
      { name: 'antimatterPerSecond', internalType: 'uint256', type: 'uint256' },
      {
        name: 'accAntimatterPerShare',
        internalType: 'uint256',
        type: 'uint256',
      },
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'enum StableStakerV2.PoolState',
        type: 'uint8',
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    name: 'yieldStrategy',
    outputs: [
      { name: '', internalType: 'contract IYieldStrategy', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [
      ...
      { name: 'user', internalType: 'address', type: 'address', indexed: true },
      {
        name: 'antimatterBurned',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
      {
        name: 'principalConsumed',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        name: 'antimatterAmountPerDay',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
      {
        name: 'antimatterPerSecond',
        internalType: 'uint256',
        type: 'uint256',
        indexed: false,
      },
...
export const stableYieldAccumulatorAbi = [
  ...
  {
    type: 'function',
    inputs: [{ name: '_streamer', internalType: 'address', type: 'address' }],
    name: 'setNudgeStreamer',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  { type: 'error', inputs: [], name: 'NudgeNotConfigured' },
  {
    ...
    name: 'NudgeStreamNotRegistered',
  },
  { type: 'error', inputs: [], name: 'NudgeStreamerNotConfigured' },
  {
    type: 'error',
    inputs: [{ name: 'owner', internalType: 'address', type: 'address' }],
    name: 'OwnableInvalidOwner',
...
export const uniboostAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'primeToken_', internalType: 'address', type: 'address' },
      { name: 'router_', internalType: 'address', type: 'address' },
      { name: 'targetPool_', internalType: 'address', type: 'address' },
      { name: 'targetToken_', internalType: 'address', type: 'address' },
      { name: 'initialOwner', internalType: 'address', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  ...
  {
    type: 'function',
    inputs: [{ name: 'path', internalType: 'address[]', type: 'address[]' }],
    name: 'setPrimeToPairPath',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// UniboostMintDebtHook
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

export const uniboostMintDebtHookAbi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'initialOwner', internalType: 'address', type: 'address' },
...
export const viewRouterAbi = [
  { type: 'constructor', inputs: [], stateMutability: 'nonpayable' },
  {
    type: 'function',
    inputs: [
      { name: 'page', internalType: 'bytes32', type: 'bytes32' },
      { name: 'user', internalType: 'address', type: 'address' },
    ],
    name: 'getData',
    outputs: [{ name: '', internalType: 'uint256[]', type: 'uint256[]' }],
  ...
  {
    type: 'function',
    inputs: [{ name: 'page', internalType: 'bytes32', type: 'bytes32' }],
    name: 'getNames',
    outputs: [{ name: '', internalType: 'string[]', type: 'string[]' }],
    stateMutability: 'view',
  },
  ...
  },
  {
    ...
    name: 'pages',
    outputs: [
      { name: '', internalType: 'contract IPageView', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'page', internalType: 'bytes32', type: 'bytes32' },
      { name: 'impl', internalType: 'contract IPageView', type: 'address' },
    ],
    name: 'setPage',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'page', internalType: 'bytes32', type: 'bytes32', indexed: true },
      {
        name: 'implementation',
        internalType: 'address',
        type: 'address',
