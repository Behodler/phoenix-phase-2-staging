...
contract MintPhUSD is Script {
    ...
    function run() external {
        ...
        MockRewardToken(rewardToken).approve(minter, stablecoinAmount);
        console.log("Approved stablecoin for minter");

        // Step 2: Mint phUSD
        PhusdStableMinter(minter).mint(rewardToken, stablecoinAmount);
